...
echo.  \ \  / /^| ^|    ^| (___ ^| ^|  ^| ^|         \ \  /\  / / ^|  ^| ^| ^|__) ^| \  / ^|
echo.   \ \/ / ^| ^|     \___ \^| ^|  ^| ^| version  \ \/  \/ /^| ^|  ^| ^|  _  /^| ^|\/^| ^|
echo.    \  /  ^| ^|____ ____) ^| ^|__^| ^|   1.0     \  /\  / ^| ^|__^| ^| ^| \ \^| ^|  ^| ^|
echo.  ___\/  _^|______^|_____/ \____/_____ __  __ \/  \/   \____/^|_^|__\_\_^|__^|_^|
echo. ^|  __ \^|  ____^|   /\   ^| \ ^| ^|_   _^|  \/  ^|   /\   ^|  __ \ / __ \^|  __ \ 
echo. ^| ^|__) ^| ^|__     /  \  ^|  \^| ^| ^| ^| ^| \  / ^|  /  \  ^| ^|__) ^| ^|  ^| ^| ^|__) ^|
echo. ^|  _  /^|  __^|   / /\ \ ^| . ` ^| ^| ^| ^| ^|\/^| ^| / /\ \ ^|  _  /^| ^|  ^| ^|  _  / 
echo. ^| ^| \ \^| ^|____ / ____ \^| ^|\  ^|_^| ^|_^| ^|  ^| ^|/ ____ \^| ^| \ \^| ^|__^| ^| ^| \ \ 
echo. ^|_^|  \_\______/_/    \_\_^| \_^|_____^|_^|  ^|_/_/    \_\_^|  \_\\____/^|_^|  \_\ 
...
echo.
echo.1. Завершение процесса-вирусоносителя...

::wscript killing
TASKKILL /F /T /IM wscript.exe > nul || (
echo.Процесс не был обнаружен, на данной машине вирус не активен
goto stage2
)
echo.	Успешно!
